        ...
        <div className={styles.container}>
            <Tabs className={styles.tab_container} selectedIndex={tabIndex} onSelect={(indx) => setTabIndex(indx)}>
                <TabList className={styles.tab_list}>
                    <Tab selectedClassName={styles.tab_selected} className={styles.tab}>Today</Tab>
                    <Tab selectedClassName={styles.tab_selected} className={styles.tab}>Yesterday</Tab>
                    <Tab selectedClassName={styles.tab_selected} className={styles.tab}>Weekly</Tab>
                </TabList>
